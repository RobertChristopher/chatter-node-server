...
export default (req, res, next) => {
  ...
  if(req.headers['x-access-token']) {
    ...
    try {
      ...
      req.twitter_oauth_token_secret = decoded_token.twitter_oauth_token_secret
      req.user_id = String(decoded_token.user_id)
  ...
  } else if(request && request.name && request.pass) {
      ...
      req.user.id = String(profile.id_str)
